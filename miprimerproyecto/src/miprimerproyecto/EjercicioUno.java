...
public class EjercicioUno {
	...
	System.out.println(miPrimerContador);
	...
	//Instrucciones con precendencia 
	...
	System.out.println("Múltiple: "+ (ingresoDelDocente < 750000 && superficieDelDocente < 300)); //true
	...
	if (unNumero < otroNumero) {
		...
		unNumero = 20;
		System.out.println("Es falso, entonces al número más grande le sume 20");
	}
	...
	double ingresoDeLaPersona = 500000;
	int superficieDeLaPersona = 15;
	int energiaDeLaPersona = 0;
			
	if (ingresoDeLaPersona < ingresosCatA
